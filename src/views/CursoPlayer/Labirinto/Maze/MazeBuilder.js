class MazeBuilder {
  ...
  countSteps(array, r, c, val, stop) {
    ...
    if (
      this.maze[r][c].includes("tile-6-3") ||
      this.maze[r][c].includes("tile-6-4") ||
      this.maze[r][c].includes("tile-6-5") ||
      this.maze[r][c].includes("tile-6-6")
    ) {
  ...
  getKeyLocation() {
    ...
    for (let j = 1; j < this.cols - 1; j++) {
      ...
      if (
        this.maze[0][j].includes("tile-6-3") ||
        this.maze[0][j].includes("tile-6-4") ||
